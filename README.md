...
│
├── spec/
│   ├── spec-v5.md         ← Current spec: ICP sharpening, Start Here, Live Post Mode ✅
...
│
├── docs/
│   ├── processing-logic-v5.md    ← How the AI processes a spec (v5) ✅
...
| Understand the AI's processing flow | `docs/processing-logic-v5.md` |
